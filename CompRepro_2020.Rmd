...
--> A major suggestion by Wilson et al is to keep data and files organized. THat includes code to make analysis and including # to make comments to specifically understand what each chunk of code means and how it contributes to the overall analysis. 
